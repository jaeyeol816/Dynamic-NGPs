...
def run_colmap(args):
	...
	do_system(f"{colmap_binary} bundle_adjuster --input_path {sparse}/0 {sparse}/1 {sparse}/2 {sparse}/3 {sparse}/4 --output_path {sparse}/0 {sparse}/1 {sparse}/2 {sparse}/3 {sparse}/4 --BundleAdjustment.refine_principal_point 1")
	try:
		shutil.rmtree(text)
	except:
		pass
	do_system(f"mkdir {text}")
	do_system(f"{colmap_binary} model_converter --input_path {sparse}/0 {sparse}/1 {sparse}/2 {sparse}/3 {sparse}/4 --output_path {text} --output_type TXT")
